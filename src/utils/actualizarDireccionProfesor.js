...
const actualizarDireccionProfesor = (inputBody,callback) => {
    request({
        url: 'http://localhost:8081/api/profesor/' + inputBody.trabajador + '/direccion',
        method: 'PATCH',
...
module.exports = actualizarDireccionProfesor